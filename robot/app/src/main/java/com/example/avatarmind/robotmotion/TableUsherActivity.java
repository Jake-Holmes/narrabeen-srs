    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.main_motors:
                intent.setClass(TableUsherActivity.this, MotorsActivity.class);
                break;
            case R.id.main_head:
                intent.setClass(TableUsherActivity.this, HeadActivity.class);
                break;
            case R.id.main_wheel:
                intent.setClass(TableUsherActivity.this, WheelActivity.class);
                break;
            case R.id.main_emoji:
                intent.setClass(TableUsherActivity.this, EmojiActivity.class);
                break;
